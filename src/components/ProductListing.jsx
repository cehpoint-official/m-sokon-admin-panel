...
const ProductListing = () => {
  ...
  // Sample data for Product listings with descriptions for reviews
  const ProductListings = [
    {
      title: "Product Listing 1",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
      sellerName: "John Doe",
      reviewDescription: "Excellent Product with great communication.",
    ...
    },
    {
      ...
      reviewDescription: "Good Product, but could improve response time.",
      sellerType: "Product Seller",
      price: "3000",
    ...
    {
      title: "Product Listing 6",
      description:
        "Ut enim ad minim veniam, quis nostrud exercitation ullamco.",
      sellerName: "Alice Johnson",
      reviewDescription: "Outstanding Product. Highly recommended.",
      sellerType: "Product Seller",
      price: "3000",
      status: "blocked",
    },
    {
      title: "Product Listing 7",
      description:
        "Ut enim ad minim veniam, quis nostrud exercitation ullamco.",
      sellerName: "Alice Johnson",
      reviewDescription: "Outstanding Product. Highly recommended.",
    ...
    {
      title: "Product Listing 10",
      description:
        "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.",
      sellerName: "Bob Wilson",
      reviewDescription: "Top-notch Product. No complaints whatsoever.",
      sellerType: "Product Seller",
      price: "3000",
      status: "inactive",
    },
    {
      title: "Product Listing 11",
      description:
        "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.",
      sellerName: "Bob Wilson",
      reviewDescription: "Top-notch Product. No complaints whatsoever.",
